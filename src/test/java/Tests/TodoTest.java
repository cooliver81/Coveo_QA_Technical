...
public class TodoTest extends AbstractTest {
	...
	// Test adding two todos to the list, one from AllPage and another from CompletedPage 
	// Verifies adding to list from Completed (shouldn't show the either todo)
    	@Test
	...
	// Test completing a todo and check Active and Completed lists to verify 
	@Test
	...
	// Test completing a todo in ActivePage
	@Test
	...
	// Test functionality of "Clear Completed" button
	@Test
	...
	// Test deleting a todo and verify all pages
	@Test
	...
	// Test functionality of modifying a todo and verify Pages
	@Test
	...
	// Test uncompleting a completed todo and verify in all Pages 
	// NOTE: would have used the functionality to complete all todos but the function doesn't work
	@Test
